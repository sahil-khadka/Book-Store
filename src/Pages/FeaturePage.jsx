...
const FeaturePage = () => {
  ...
  // Extract price value from the price string (e.g., "$29.99" -> 29.99)
  const priceValue = Math.abs(parseFloat(book.price.replace("$", "")));
  ...
  const handleAddToCart = () => {
    ...
    const itemToAdd = {
      ...
      calculatedPrice: priceValue, // Ensure positive price
    };
  ...
  const totalPrice = Math.abs(priceValue * quantity).toFixed(2);
            ...
            >
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full text-sm font-semibold shadow-lg">
                    Featured Selection
                  </span>
                  ...
                  <span className="px-4 py-2 bg-gradient-to-r from-green-500 to-teal-500 text-white rounded-full text-sm font-semibold shadow-lg">
                    Bestseller
                  </span>
                </div>
              </div>
