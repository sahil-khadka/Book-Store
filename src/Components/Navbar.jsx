    ...
    <nav className="bg-lime-200 relative ">
      <div className=" align-element  rounded-2xl text-black grid grid-cols-3 items-center">
        <div className=" justify-self-start ">
          <NavLink
            to="/"
            className="bg-gray-100 text-black flex items-center justify-center font-bold  w-18  lg:flex text-3xl mt-3 mb-3 rounded-lg px-5 py-3 hover:bg-green-300 transition-all "
          >
            BK
          </NavLink>
